...
#include "../../Lab1-SocketProgramming/communicate.h"
...
QT_MOC_LITERAL(1, 12, 17), // "FinishCommunicate"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 3) // "msg"

    },
    "Communicate\0FinishCommunicate\0\0msg"
};
...
void Communicate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->FinishCommunicate((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Communicate::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communicate::FinishCommunicate)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Communicate::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Communicate.data,
...
// SIGNAL 0
void Communicate::FinishCommunicate(QStringList _t1)
{
