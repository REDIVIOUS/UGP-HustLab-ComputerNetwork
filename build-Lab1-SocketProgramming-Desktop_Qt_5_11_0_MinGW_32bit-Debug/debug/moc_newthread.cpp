...
#include "../../Lab1-SocketProgramming/newthread.h"
...
QT_MOC_LITERAL(1, 10, 6), // "getnew"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 3), // "msg"
QT_MOC_LITERAL(4, 22, 9) // "FinishNew"

    },
    "NewThread\0getnew\0\0msg\0FinishNew"
};
...
void NewThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getnew((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        case 1: _t->FinishNew(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NewThread::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NewThread::getnew)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NewThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NewThread::FinishNew)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NewThread::getnew(QStringList _t1)
{
